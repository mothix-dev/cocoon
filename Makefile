...
CFLAGS += -O2 -Isrc -Inanoprintf -Iprintf -nostdlib -fno-builtin -ffreestanding -fno-stack-protector -static -Wall -mregparm=3 -DPRINTF_DISABLE_SUPPORT_LONG_LONG
...
OPENFIRMWARE_POWERPC_CFLAGS != [ "$(PLATFORM)" = openfirmware-powerpc ] && echo "-target ppc32-unknown-none -mcpu=601 -DOPENFIRMWARE" || echo ""
OPENFIRMWARE_X86_CFLAGS != [ "$(PLATFORM)" = openfirmware-x86 ] && echo "-target i586-unknown-none -march=i586 -DOPENFIRMWARE" || echo ""
